...
import { DEFAULT_FEE, INITIAL_TRANSACTION_AMOUNT, MINIMUM_NONCE } from './../../tools/const';
...
export const checkBalanceAfterTransaction = ({balance,transactionData}:IBalanceBeforeTransaction) => {
